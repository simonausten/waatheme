 ...
 */
	...
	function html5reset_scripts_styles() {
		...
		wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/_/css/vendor/bootstrap.min.css' );

		wp_enqueue_style( 'reset', get_template_directory_uri() . '/reset.css' );
		wp_enqueue_style( 'style', get_stylesheet_uri() );
		wp_enqueue_style( 'responsive-sm', get_template_directory_uri() . '/_/css/responsive-sm.css', array(), '', 'screen and (min-width: 768px)');
		wp_enqueue_style( 'responsive-md', get_template_directory_uri() . '/_/css/responsive-md.css', array(), '', 'screen and (min-width: 992px)');
		wp_enqueue_style( 'responsive-lg', get_template_directory_uri() . '/_/css/responsive-lg.css', array(), '', 'screen and (min-width: 1200px)');
