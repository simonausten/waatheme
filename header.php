	...
	<?php
		...
		*/
		if (true == of_get_option('meta_viewport'))
			echo '<meta name="viewport" content="' . trim(of_get_option("meta_viewport")) . ', minimal-ui" />';
...
<body <?php body_class(); ?>>
	...
	<div class='devtool' id='ruler'></div>
	<div class='devtool' id='template-name'><?= get_page_template() ?></div>
